...
class User
  ...
  module GeneratedAssociationMethods
    ...
    def repo_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :repos`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Repo::PrivateCollectionProxy) }
    def repos; end

    sig { params(value: T::Enumerable[::Repo]).void }
    def repos=(value); end
  end
